 ...
 *
 * Contributors: IBM Corporation - initial API and implementation Christoph Läubrich - adjusted to
 * use panama
 *******************************************************************************/
...
// MACOS: --enable-native-access=ALL-UNNAMED
// -Djava.library.path=.:/System/Library/Frameworks/OpenGL.framework/Versions/Current/Libraries/
// -XstartOnFirstThread
public class DemoThorus_SWT implements GLEventListener {
  ...
  public static void main(String[] args) {
    ...
    DemoThorus_SWT torus = new DemoThorus_SWT();
    canvas.setGLEventListener(torus);

    shell.setSize(640, 480);
    shell.open();

    // Wait for available display
