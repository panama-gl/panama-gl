...
public interface GL_1_5 extends GL_1_4 {
  ...
  public static int GL_QUERY_COUNTER_BITS = 0x8864;
  ...
  public static int GL_SAMPLES_PASSED = 0x8914;
  ...
  public static int GL_INDEX_ARRAY_BUFFER_BINDING = 0x8899;
  public static int GL_TEXTURE_COORD_ARRAY_BUFFER_BINDING = 0x889A;
  public static int GL_EDGE_FLAG_ARRAY_BUFFER_BINDING = 0x889B;
  public static int GL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING = 0x889C;
  public static int GL_FOG_COORDINATE_ARRAY_BUFFER_BINDING = 0x889D;
  public static int GL_WEIGHT_ARRAY_BUFFER_BINDING = 0x889E;
  public static int GL_FOG_COORD_SRC = 0x8450;
  public static int GL_FOG_COORD = 0x8451;
  public static int GL_CURRENT_FOG_COORD = 0x8453;
  public static int GL_FOG_COORD_ARRAY_TYPE = 0x8454;
  public static int GL_FOG_COORD_ARRAY_STRIDE = 0x8455;
  public static int GL_FOG_COORD_ARRAY_POINTER = 0x8456;
  public static int GL_FOG_COORD_ARRAY = 0x8457;
  public static int GL_FOG_COORD_ARRAY_BUFFER_BINDING = 0x889D;
