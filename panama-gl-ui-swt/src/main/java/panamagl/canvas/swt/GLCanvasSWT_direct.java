...
public class GLCanvasSWT_direct extends org.eclipse.swt.opengl.GLCanvas
  ...
  public GLCanvasSWT_direct(Composite parent, int style, PanamaGLFactory glFactory) {
    this(parent, style, createDefaultGLData(), glFactory);
  }

  public GLCanvasSWT_direct(Composite parent, int style, GLData data, PanamaGLFactory glFactory) {
    super(parent, style, data);
    
    this.factory = glFactory;
