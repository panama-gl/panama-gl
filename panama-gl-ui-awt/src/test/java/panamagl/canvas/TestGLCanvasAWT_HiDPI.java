...
public class TestGLCanvasAWT_HiDPI {
  ...
  public void physicalSize_followsLogical_whenHiDPIDisabled() {
    // Avoid setSize: it would fire componentResized -> offscreen.onResize on a non-initialized
    // offscreen, producing harmless but noisy stack traces in test output.
    GLCanvasAWT canvas = newCanvas();
